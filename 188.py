...
for j in range(start,end):     
    ...
    prominent_leader={'VAKHIL SHAIKH':'SHINDE','GANGA BHARTE':'UBT','RAJESH KAJARE':'SHS','Ni':'Ni'}
    ...
    pc_leader=['VARSHA GAIKWAD','ASHISH MORE','Ni']
